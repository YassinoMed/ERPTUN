{{ Form::open(['url' => 'cap-table', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('holder_type', $holderTypes, 'individual', ['class' => 'form-control select', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('share_count', 0, ['class' => 'form-control', 'step' => '0.0001', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('issue_price', __('Issue Price'), ['class' => 'form-label']) }}
                {{ Form::number('issue_price', 0, ['class' => 'form-control', 'step' => '0.0001']) }}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {{ Form::label('ownership_percentage', __('Ownership %'), ['class' => 'form-label']) }}
                {{ Form::number('ownership_percentage', 0, ['class' => 'form-control', 'step' => '0.0001']) }}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {{ Form::label('voting_percentage', __('Voting %'), ['class' => 'form-label']) }}
                {{ Form::number('voting_percentage', 0, ['class' => 'form-control', 'step' => '0.0001']) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
