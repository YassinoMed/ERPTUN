{{ Form::model($room, ['route' => ['hospital-rooms.update', $room->id], 'method' => 'put']) }}
<div class="modal-body"><div class="row">
    ...
    <div class="col-md-6 mt-2">{{ Form::label('status', __('Status'), ['class' => 'form-label']) }}{{ Form::select('status', ['available' => __('Available'), 'maintenance' => __('Maintenance'), 'occupied' => __('Occupied')], $room->status, ['class' => 'form-control']) }}</div>
</div></div>
