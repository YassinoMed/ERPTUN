{{ Form::open(['url' => 'security-incidents', 'method' => 'post']) }}
...
<div class="col-md-3"><div class="form-group">{{ Form::label('status', __('Status'), ['class'=>'form-label']) }}{{ Form::select('status', $statuses, 'open', ['class'=>'form-control select']) }}</div></div>
<div class="col-md-4"><div class="form-group">{{ Form::label('severity', __('Severity'), ['class'=>'form-label']) }}{{ Form::select('severity', $severities, 'medium', ['class'=>'form-control select']) }}</div></div>
<div class="col-md-4"><div class="form-group">{{ Form::label('reported_by', __('Reported By'), ['class'=>'form-label']) }}{{ Form::select('reported_by', $users, Auth::id(), ['class'=>'form-control select']) }}</div></div>
<div class="col-md-4"><div class="form-group">{{ Form::label('owner_id', __('Owner'), ['class'=>'form-label']) }}{{ Form::select('owner_id', $users, null, ['class'=>'form-control select']) }}</div></div>
...
<div class="col-md-6"><div class="form-group">{{ Form::label('detected_at', __('Detected At'), ['class'=>'form-label']) }}{{ Form::datetimeLocal('detected_at', null, ['class'=>'form-control']) }}</div></div>
