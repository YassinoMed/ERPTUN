{{ Form::open(['url' => 'board-meeting', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="form-group">
                ...
                {{ Form::select('status', $statuses, 'scheduled', ['class' => 'form-control select', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-md-6 col-12">
            <div class="form-group">
        ...
        <div class="col-md-12 col-12">
            <div class="form-group">
                ...
                {{ Form::select('attendee_ids[]', $employees, null, ['class' => 'form-control select', 'multiple' => 'multiple', 'required' => 'required']) }}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
