{{ Form::open(['url' => 'insurance-policies', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-3"><div class="form-group">{{ Form::label('start_date', __('Start Date'), ['class' => 'form-label']) }}{{ Form::date('start_date', null, ['class' => 'form-control']) }}</div></div>
        <div class="col-md-3"><div class="form-group">{{ Form::label('end_date', __('End Date'), ['class' => 'form-label']) }}{{ Form::date('end_date', null, ['class' => 'form-control']) }}</div></div>
        <div class="col-md-3"><div class="form-group">{{ Form::label('premium_amount', __('Premium Amount'), ['class' => 'form-label']) }}{{ Form::number('premium_amount', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => '0']) }}</div></div>
        <div class="col-md-3"><div class="form-group">{{ Form::label('coverage_amount', __('Coverage Amount'), ['class' => 'form-label']) }}{{ Form::number('coverage_amount', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => '0']) }}</div></div>
