{{ Form::open(['url' => 'data-consents', 'method' => 'post']) }}
...
<div class="col-md-4"><div class="form-group">{{ Form::label('status', __('Status'), ['class'=>'form-label']) }}{{ Form::select('status', $statuses, 'granted', ['class'=>'form-control select']) }}</div></div>
<div class="col-md-4"><div class="form-group">{{ Form::label('consented_at', __('Consented At'), ['class'=>'form-label']) }}{{ Form::date('consented_at', now()->format('Y-m-d'), ['class'=>'form-control']) }}</div></div>
<div class="col-md-6"><div class="form-group">{{ Form::label('expires_at', __('Expires At'), ['class'=>'form-label']) }}{{ Form::date('expires_at', null, ['class'=>'form-control']) }}</div></div>
