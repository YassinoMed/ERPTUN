{{ Form::open(['url' => 'knowledge-base', 'method' => 'post', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-4"><div class="form-group">{{ Form::label('knowledge_base_category_id', __('Category'), ['class' => 'form-label']) }}{{ Form::select('knowledge_base_category_id', $categories, null, ['class' => 'form-control select']) }}</div></div>
