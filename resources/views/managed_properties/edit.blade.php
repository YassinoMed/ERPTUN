{{ Form::model($managedProperty, ['route' => ['managed-properties.update', $managedProperty->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-md-6"><div class="form-group">{{ Form::label('manager_employee_id', __('Manager'), ['class' => 'form-label']) }}{{ Form::select('manager_employee_id', $employees, $managedProperty->manager_employee_id, ['class' => 'form-control select']) }}</div></div>
        ...
        <div class="col-md-4"><div class="form-group">{{ Form::label('status', __('Status'), ['class' => 'form-label']) }}<x-required></x-required>{{ Form::select('status', $statuses, $managedProperty->status, ['class' => 'form-control select', 'required' => 'required']) }}</div></div>
