{{ Form::model($bed, ['route' => ['hospital-beds.update', $bed->id], 'method' => 'put']) }}
<div class="modal-body"><div class="row">
    ...
    <div class="col-md-12 mt-2">{{ Form::label('status', __('Status'), ['class' => 'form-label']) }}{{ Form::select('status', ['available' => __('Available'), 'occupied' => __('Occupied'), 'maintenance' => __('Maintenance')], $bed->status, ['class' => 'form-control']) }}</div>
</div></div>
