{{ Form::model($resource, ['route' => ['production.resources.update', $resource->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            {{ Form::label('type', __('Type'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::select('type', ['site' => __('Site'), 'workshop' => __('Workshop'), 'line' => __('Line'), 'station' => __('Station')], null, ['class' => 'form-control']) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('status', ['active' => __('Active'), 'inactive' => __('Inactive'), 'maintenance' => __('Maintenance')], null, ['class' => 'form-control']) }}
        </div>
