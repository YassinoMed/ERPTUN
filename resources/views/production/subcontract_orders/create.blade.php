{{ Form::open(['url' => route('production.subcontract-orders.store'), 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body"><div class="row">
    ...
    <div class="form-group col-md-4">{{ Form::label('status', __('Status'), ['class' => 'form-label']) }}{{ Form::select('status', ['draft'=>__('Draft'),'sent'=>__('Sent'),'in_progress'=>__('In Progress'),'received'=>__('Received'),'closed'=>__('Closed'),'cancelled'=>__('Cancelled')], 'draft', ['class' => 'form-control']) }}</div>
    <div class="form-group col-md-4">{{ Form::label('quantity', __('Quantity'), ['class' => 'form-label']) }}{{ Form::number('quantity', 1, ['class' => 'form-control','step'=>'0.0001','min'=>0.0001]) }}</div>
    <div class="form-group col-md-4">{{ Form::label('unit_cost', __('Unit Cost'), ['class' => 'form-label']) }}{{ Form::number('unit_cost', 0, ['class' => 'form-control','step'=>'0.01','min'=>0]) }}</div>
    <div class="form-group col-md-6">{{ Form::label('planned_send_date', __('Planned Send Date'), ['class' => 'form-label']) }}{{ Form::date('planned_send_date', null, ['class' => 'form-control']) }}</div>
    <div class="form-group col-md-6">{{ Form::label('planned_receive_date', __('Planned Receive Date'), ['class' => 'form-label']) }}{{ Form::date('planned_receive_date', null, ['class' => 'form-control']) }}</div>
