{{ Form::open(['url' => route('production.quality-plans.store'), 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body"><div class="row">
    ...
    <div class="form-group col-md-3">{{ Form::label('check_stage', __('Stage'), ['class' => 'form-label']) }}{{ Form::select('check_stage', ['incoming'=>__('Incoming'),'in_process'=>__('In Process'),'final'=>__('Final')], 'in_process', ['class' => 'form-control']) }}</div>
    <div class="form-group col-md-3">{{ Form::label('status', __('Status'), ['class' => 'form-label']) }}{{ Form::select('status', ['active'=>__('Active'),'inactive'=>__('Inactive')], 'active', ['class' => 'form-control']) }}</div>
