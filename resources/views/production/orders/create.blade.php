{{ Form::open(['url' => 'production/orders', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('quantity_planned', __('Planned Quantity'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::number('quantity_planned', 1, ['class' => 'form-control', 'required' => 'required', 'step' => '0.0001', 'min' => 0.0001]) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('priority', ['low' => __('Low'), 'normal' => __('Normal'), 'high' => __('High'), 'urgent' => __('Urgent')], 'normal', ['class' => 'form-control', 'required' => 'required']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('planned_machine_hours', __('Planned Machine Hours'), ['class' => 'form-label']) }}
            {{ Form::number('planned_machine_hours', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0]) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('planned_labor_hours', __('Planned Labor Hours'), ['class' => 'form-label']) }}
            {{ Form::number('planned_labor_hours', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0]) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('planned_start_date', __('Planned Start Date'), ['class' => 'form-label']) }}
            {{ Form::date('planned_start_date', null, ['class' => 'form-control']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('planned_end_date', __('Planned End Date'), ['class' => 'form-label']) }}
            {{ Form::date('planned_end_date', null, ['class' => 'form-control']) }}
        </div>
