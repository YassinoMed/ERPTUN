{{ Form::open(['url' => 'production/work-centers', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::select('type', ['machine' => __('Machine'), 'workshop' => __('Workshop'), 'employee' => __('Employee')], 'machine', ['class' => 'form-control', 'required' => 'required']) }}
        </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::number('cost_per_hour', 0, ['class' => 'form-control', 'step' => '0.01', 'min' => 0]) }}
        </div>
