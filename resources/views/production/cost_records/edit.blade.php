{{ Form::model($costRecord, ['route' => ['production.cost-records.update', $costRecord->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body"><div class="row">
    ...
    <div class="form-group col-md-4">{{ Form::label('cost_type', __('Cost Type'), ['class' => 'form-label']) }}{{ Form::select('cost_type', ['material'=>__('Material'),'machine'=>__('Machine'),'labor'=>__('Labor'),'overhead'=>__('Overhead'),'subcontract'=>__('Subcontract')], null, ['class' => 'form-control']) }}</div>
    <div class="form-group col-md-4">{{ Form::label('amount', __('Amount'), ['class' => 'form-label']) }}{{ Form::number('amount', null, ['class' => 'form-control','step'=>'0.01','min'=>0]) }}</div>
    <div class="form-group col-md-4">{{ Form::label('quantity_basis', __('Quantity Basis'), ['class' => 'form-label']) }}{{ Form::number('quantity_basis', null, ['class' => 'form-control','step'=>'0.0001','min'=>0]) }}</div>
