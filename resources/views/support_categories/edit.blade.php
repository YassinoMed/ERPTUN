{{ Form::model($supportCategory, ['route' => ['support-categories.update', $supportCategory->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::color('color', $supportCategory->color ?: '#3B82F6', ['class' => 'form-control form-control-color w-100']) }}
            <div class="form-check mt-3">
                {{ Form::checkbox('is_active', 1, $supportCategory->is_active, ['class' => 'form-check-input', 'id' => 'support-category-active']) }}
